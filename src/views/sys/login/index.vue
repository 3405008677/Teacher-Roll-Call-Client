    ...
    <div class="login-content">
      <div class="login-content-main">
        ...
        <el-form
          ...
          :rules="rules"
        >
          <el-form-item prop="account" class="pt-10 pb-10 login-animation1">
            <el-input v-model="formData.account" type="text" placeholder="请输入账号" clearable>
              <template #prefix>
...
<script lang="ts" setup>
  ...
  // 用户信息
  const formData = ref({
    account: import.meta.env.VITE_WEB_ACCOUNT,
